...
public:
	...
	SpriteManager(const sf::Image textureSrc, sf::Vector2i textureLocation, sf::Vector2i textureSize, sf::Vector2f location = { 0.0f, 0.0f }, sf::Vector2f scale = { 1.0f,1.0f }, e_objectOrigin origin = e_objectOrigin::TOPLEFT);
	...
	// move constructor
	SpriteManager(SpriteManager&& other);
